...
### Firmware + CPS version 4.00

### Προσθήκη
- GMRS αναμεταδότες 2 και 3.
 
### Αλλαγή
- Αλλαγή στις ζώνες. τώρα έχουμε ομαδοποίηση σε Αθήνα, Στερεά Ελλάδα, Πελοπόννησο, Θεσσαλία, Ήπειρο, Μακεδονία Κεντρική/Δυτική/Ανατολική, Ιόνιο, Αιγαίο Νότιο/Βόρειο, Κρήτη. 
  
### Κατάργηση
- Ανενεργών επαναληπτών σύμφωνα με το RepeaterBook.
